...
function requireSafeStableStringify() {
  return hasRequiredSafeStableStringify || (hasRequiredSafeStableStringify = 1, (function(module2, exports$1) {
    const { hasOwnProperty } = Object.prototype, stringify = configure();
    stringify.configure = configure, stringify.stringify = stringify, stringify.default = stringify, exports$1.stringify = stringify, exports$1.configure = configure, module2.exports = stringify;
...
let clean = /* @__PURE__ */ Symbol("clean"), listenerQueue = [], lqIndex = 0;
